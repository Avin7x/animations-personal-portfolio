        ...
        <motion.div className="hero-content"
         variants={staggerContainer}
          ...
          <motion.p className="hero-description" variants={fadeInUp}>
            Passionate full stack developer with a love for clean code and intuitive user experiences. I specialize in building scalable web applications that solve real-world problems, from sleek frontends to robust backend systems.
          </motion.p>
